...
```{r}
setwd("C:/Users/s196814/Desktop/Analiza/GWAS")
...
4.  Przeprowadź kontrolę jakości (QC) danych markerowych: Zastąp brakujące dane markerowe średnią wartością dla każdego markera.
...
5.  Wykonaj analizę PCA: Utwórz macierz markerów.
...
6.  Przygotuj dane do analizy GWAS: Przygotuj dane genotypowe i fenotypowe do analizy.
...
9.  Zinterpretuj wyniki: Jakie markery SNP są potencjalnie istotne? Jakie wnioski można wyciągnąć na podstawie analizy PCA i wyników GWAS?
